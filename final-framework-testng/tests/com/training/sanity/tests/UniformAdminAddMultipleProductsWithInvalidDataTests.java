...
public class UniformAdminAddMultipleProductsWithInvalidDataTests {
	...
	@Test(dataProvider = "excel-inputs-products-invalid", dataProviderClass = LoginDataProviders.class)
	...
	public void AddMultipleProductsWithExcel(String ProductName, String MetaTagTitle, String Model, String Price, String Quantity, String Category)
	{
		...
		String expected = addProductPagePOM.getWarningMessage();
		String actual= "Warning: Please check the form carefully for errors!";
		Assert.assertTrue(expected.contains(actual));
		screenShot.captureScreenShot("AdminErrorMessageafterAddingProduct");
