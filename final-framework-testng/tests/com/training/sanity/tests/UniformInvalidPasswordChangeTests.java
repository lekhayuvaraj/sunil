...
public class UniformInvalidPasswordChangeTests {
	...
	public void invalidChangePasswordTest() {
		...
		changePasswordpagePOM.sendPassword("lekha12345");
		...
		String actual = changePasswordpagePOM.displayPasswordFailureAlert();
		//assert
		 Assert.assertEquals(expected,actual, "confirmation password not matched.TestCase failed");
		screenShot.captureScreenShot("InvalidPasswordChange");
