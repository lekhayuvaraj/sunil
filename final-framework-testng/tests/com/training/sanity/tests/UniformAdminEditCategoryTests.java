...
public class UniformAdminEditCategoryTests {
	...
	public void adminEditCategoryTest() {
		...
		addCategoryPOM.clickEditBlazers();
		EditCategoryPOM.clearMetaTagTitle("BLZ03");
		EditCategoryPOM.clearMetaTagDescription("uniform of students");
		EditCategoryPOM.saveCategory();
		String expected = adminDashboardPOM.getAddedSuccessMessage();
		String actual= "Success: You have modified categories!";
		Assert.assertTrue(expected.contains(actual));
		screenShot.captureScreenShot("AdminCategoryEdited");
