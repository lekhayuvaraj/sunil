...
public class UniformProductAddedToCartTests {
	...
	public void productAddedToCartTest() {
		...
		String actual = "Regular T-Shirt (Royal Blue)";
		String expected = checkOutCartPOM.displayProductDescription();
		//assert
		 Assert.assertEquals(actual,expected, "Product description not displayed.TestCase failed");
		
		
		 
		
		screenShot.captureScreenShot("AddedProductDescription");
	}
