...
public class UniformAdminAddCategoryTests {
	...
	@Test(priority=1)
	public void adminAddCategoryTest() {
		
		adminDashboardPOM.moveToCategory();
		adminDashboardPOM.AddNewCategory();
		addCategoryPOM.addCategoryName("Blazers(4-5)");
		addCategoryPOM.addCategoryDescription("blazers for students");
		addCategoryPOM.addCategoryTagTitle("BLZ03");
		addCategoryPOM.addCategoryTagDescription("Blazers for primary class students");
		...
		screenShot.captureScreenShot("AdminCategoryAdded");
