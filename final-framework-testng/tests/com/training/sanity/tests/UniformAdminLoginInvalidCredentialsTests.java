...
public class UniformAdminLoginInvalidCredentialsTests {
	...
	public void InvalidAdminLoginTest() {
		...
		adminLoginPOM.sendPassword("lekha@123");
		adminLoginPOM.clickLoginButton();
		String expected = adminLoginPOM.getAlertMessage();
		
		String actual = "No match for Username and/or Password.";
		 //assert
		Assert.assertTrue(expected.contains(actual));
		 
        screenShot.captureScreenShot("AdminLoginInvalid");
	}
